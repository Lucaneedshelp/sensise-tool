function getSystemPrompt(searchContext = '') {
  const instructions = [
    ...
    'Verwechsle keine Geraete: SAB07-Regeln wie 0D00 und 4E XX gelten nur fuer SAB07, nicht fuer NOVOS 3.',
    'Unterscheide Uplink und Downlink klar: Uplink kommt vom Geraet zum Server; Downlink wird an das Geraet gesendet.',
    'NOVOS 3 Temperatur-Uplink: Identifier 0x10, Datentyp INT16, Grad Celsius mal 10, Big-Endian. 45 Grad Celsius ergibt Rohwert 450 dezimal = 01C2 hex, also Payload 10 01C2 bzw. 1001C2.',
